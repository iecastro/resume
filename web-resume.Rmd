...
Background in research project coordination, biostatistics, and population health data science. Proficiency with data formatting, handling, and analysis.  
...
- R and RStudio with emphasis on the `tidyverse` and `tidymodels`
...
- [Vacantioning and Health](http://vacationhealthstudy.syr.edu/)
...
- Created research databases (Excel, Access)
